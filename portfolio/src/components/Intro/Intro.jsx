    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>Zineddine Tadjer</span>
          <span>
            Junior Full Stack with experience in web designing and development,
            producting the Quality work using ReactJs/NodeJs.
          </span>
        </div>
      ...
      <div className="i-right">
        <img src={Vector1} alt="" />
        <img src={Vector2} alt="" />
        <img src={boy} alt="" className="photo" />
        {/* animation */}
        <motion.img
          initial={{ left: "-36%" }}
          whileInView={{ left: "-24%" }}
